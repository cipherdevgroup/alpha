...
It uses the [Theme Hook Alliance](https://github.com/zamoose/themehookalliance) hooks and our drop-in theme framework [CareLib](https://github.com/wpsitecare/carelib) for templating. Alpha also integrates Grunt, SCSS, Bower, and Composer for workflow automation.
